...
class AgendaPage extends StatefulWidget{
  ...
  AgendaPage({Key key, this.id, this.view}) : super(key : key);

  AgendaPageState  createState() => AgendaPageState(id: id,view: view);
}
...
class AgendaPageState extends State<AgendaPage> {
  ...
  AgendaPageState({Key key, this.id,this.view});
